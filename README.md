...
- **Cross-Platform Rendering**: Support for video rendering on both **NVIDIA (CUDA)** and **Apple Silicon (MPS)**.
- **Intuitive Web UI**: 
    ...
    - **Real-Time Preview**: Watch your video renders appear progressively.
...
2. **Configure**: Select "Generate Video Immediately" if you have a supported GPU (NVIDIA or Mac M-series).
...
*Please review the full license details in the "Licenses & Credits" tab within the application.*
